...
// Archive the message
$success = $contactModel->updateStatus($messageId, 'archived');

if ($success) {
    $_SESSION['flash_success'] = 'Message archived successfully.';
} else {
    $_SESSION['flash_error'] = 'Failed to archive message. Please try again.';
}
