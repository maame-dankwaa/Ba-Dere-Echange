...
CREATE TABLE IF NOT EXISTS `fp_contact_messages` (
  ...
  CONSTRAINT `fk_contact_user` FOREIGN KEY (`user_id`) REFERENCES `fp_users` (`user_id`) ON DELETE SET NULL,
  CONSTRAINT `fk_contact_admin` FOREIGN KEY (`responded_by`) REFERENCES `fp_users` (`user_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Verify the table was created
DESCRIBE `fp_contact_messages`;
